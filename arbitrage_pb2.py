...
_CONTEXT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enter_points', full_name='trading.arbitrage.Context.enter_points', index=3,
...
_CONTEXT.fields_by_name['enter_points'].message_type = _TRADINGPOINT
